...
:node-url: http://frontend-node-app.apps.pwright.openshiftworkshop.com/
:spring-url: http://spring-boot-rest-http-crud-spring-app.apps.pwright.openshiftworkshop.com/
